...
SortedArray.prototype.set = function (num) {
    ...
    // add the number in order
     // Tìm vị trí để chèn số
     let index = this.numbers.findIndex(n => n > num);
...
const arr = new SortedArray([1, 3, 5]);
console.log("index array: ",arr.get(5));


arr.set(4);
console.log("set array: ", arr.numbers);

arr.remove(3);
console.log("remove array: ", arr.numbers);
